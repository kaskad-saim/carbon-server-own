...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (elements1.chartCanvas) {
    initializeChart('vr1', elements1, 'График давления/разрежения печи карбонизации №1');
  }
  ...
  if (elements2.chartCanvas) {
    initializeChart('vr2', elements2, 'График давления/разрежения печи карбонизации №2');
  }
