import { createChart } from '../components/chartRendererHourNotis.js';
...
function initializeChartNotis1(parameterType, elements, chartTitle) {
  ...
  const chart = createChart({
    parameterType,
    elements,
    labels: dataLabelsNotis.notisVR1,
...
function initializeChartNotis2(parameterType, elements, chartTitle) {
  let isUserInteracting = false;
  let isDataVisible = true;
  let isRealTime = true;
  let currentStartTime, currentEndTime;
  ...
  const chart = createChart({
    parameterType,
    elements,
    labels: dataLabelsNotis.notisVR2,
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (elements1.chartCanvas) {
    initializeChartNotis1('notis1', elements1, 'График нотисов печи карбонизации №1');
  }
  ...
  if (elements2.chartCanvas) {
    initializeChartNotis2('notis2', elements2, 'График нотисов печи карбонизации №2');
  }
