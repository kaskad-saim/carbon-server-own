...
//   // if (sirenVR1mnemo) {
//   //   if (modeTitle.innerText == 'Установившийся режим') {
//   //     sirenVR1mnemo.play();
//   //   } else {
//   //     sirenVR1mnemo.pause();
//   //   }
...
// //mode
// if (temper1Skolz.innerText < 550 && temper1Skolz.innerText > 50) {
//   modeTitle.innerText = 'Выход на режим';

//   if (temper3Skolz.innerText > 750) {
...
// } else if (temper1Skolz.innerText > 550) {
//   modeTitle.innerText = 'Установившийся режим';
//   if (temper3Skolz.innerText > 400) {
...
// if (temper1Skolz.innerText > 50) {
//   const temper1SkolzSpan = document.querySelector('.temper-1-skolz-span');

//   if (temper1Skolz.innerText > 800 || temper1Skolz.innerText < 550) {
...
//   let nizZagrKamChanged = nizZagrKam.innerText.replace(',', '.');
...
//   if (temperVnizKamerZagruz.innerText > 1100 || temperVnizKamerZagruz.innerText < 1000) {
...
//   if (temperVnizKamerZagruz.innerText > 1100) {
...
//   if (temperVerhKamerZagruz.innerText > 1000) {
...
//   if (temperVhodPechDozhig.innerText > 1200) {
...
//   if (temperGranulHolod.innerText > 70) {
...
//   let davlGazPosleSkruberChanged = davlGazPosleSkruber.innerText.replace(',', '.');
...
//   let davlTopkaChanged = davlTopka.innerText.replace(',', '.');
...
//   if (temperDoSkruber.innerText > 400) {
...
//   if (temperPosleSkruber.innerText > 100) {
...
//   if (temperVihodPechDozhig.innerText > 1200) {
...
//   if (temperGazovKotelUtiliz.innerText > 1100) {
...
//   let razrKotelUtilizChanged = razrKotelUtiliz.innerText.replace(',', '.');
...
//   if (temperVodyVannaSkruber.innerText > 90) {
...
//   if (temperKamerVygruz.innerText > 750) {
...
//   if (urovenBarabanKotla.innerText <= -70 || urovenBarabanKotla.innerText >= 70) {
...
//   if (urovenVannaSkrubber.innerText <= 250) {
...
//   if (urovenVodyHvo.innerText <= 1500) {
...
//   </tr>
//   `;
//   tableTbody.innerText = noDataRow;
